...
-- Loading the theme
theme_path = string.format('~/.config/awesome/themes/Nord/theme.lua', os.getenv('HOME'), 'Nord')
...
-- awful.spawn.with_shell("/home/telmo/Desktop/ASF-linux-x64/ArchiSteamFarm")
